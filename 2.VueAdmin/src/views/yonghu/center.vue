				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="户号" prop="huhao">
							<el-input class="list_inp" v-model="user.huhao"  placeholder="户号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="是否户主" prop="shifouhuzhu">
							<el-select 
								class="list_sel" 
								v-model="user.shifouhuzhu" 
								placeholder="请选择是否户主"
								>
								<el-option v-for="item in yonghushifouhuzhuLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="常驻人口" prop="changzhurenkou">
							<el-input class="list_inp" v-model="user.changzhurenkou"  placeholder="常驻人口" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="最高学历" prop="zuigaoxueli">
							<el-input class="list_inp" v-model="user.zuigaoxueli"  placeholder="最高学历" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="在读学校" prop="zaiduxuexiao">
							<el-input class="list_inp" v-model="user.zaiduxuexiao"  placeholder="在读学校" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="特殊人群" prop="teshurenqun">
							<el-select 
								class="list_sel" 
								v-model="user.teshurenqun" 
								placeholder="请选择特殊人群"
								>
								<el-option v-for="item in yonghuteshurenqunLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const yonghushifouhuzhuLists = ref([])
	const yonghuteshurenqunLists = ref([])
	const init = () => {
		yonghuxingbieLists.value = "男,女".split(',')
		yonghushifouhuzhuLists.value = "是,否".split(',')
		yonghuteshurenqunLists.value = "贫困户,残疾,留守儿童,孤寡老人,失业人群,其他".split(',')
	}
