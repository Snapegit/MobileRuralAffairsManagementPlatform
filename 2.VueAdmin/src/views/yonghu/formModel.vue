				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="户号" prop="huhao">
							<el-input class="list_inp" v-model="form.huhao" placeholder="户号"
								 type="text" 								:readonly="!isAdd||disabledForm.huhao?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="是否户主" prop="shifouhuzhu">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.shifouhuzhu?true:false"
								v-model="form.shifouhuzhu" 
								placeholder="请选择是否户主"
								>
								<el-option v-for="(item,index) in shifouhuzhuLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="常驻人口" prop="changzhurenkou">
							<el-input class="list_inp" v-model="form.changzhurenkou" placeholder="常驻人口"
								 type="text" 								:readonly="!isAdd||disabledForm.changzhurenkou?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="最高学历" prop="zuigaoxueli">
							<el-input class="list_inp" v-model="form.zuigaoxueli" placeholder="最高学历"
								 type="text" 								:readonly="!isAdd||disabledForm.zuigaoxueli?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="在读学校" prop="zaiduxuexiao">
							<el-input class="list_inp" v-model="form.zaiduxuexiao" placeholder="在读学校"
								 type="text" 								:readonly="!isAdd||disabledForm.zaiduxuexiao?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="特殊人群" prop="teshurenqun">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.teshurenqun?true:false"
								v-model="form.teshurenqun" 
								placeholder="请选择特殊人群"
								>
								<el-option v-for="(item,index) in teshurenqunLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='huhao'){
					form.value.huhao = row[x];
					disabledForm.value.huhao = true;
					continue;
				}
				if(x=='shifouhuzhu'){
					form.value.shifouhuzhu = row[x];
					disabledForm.value.shifouhuzhu = true;
					continue;
				}
				if(x=='changzhurenkou'){
					form.value.changzhurenkou = row[x];
					disabledForm.value.changzhurenkou = true;
					continue;
				}
				if(x=='zuigaoxueli'){
					form.value.zuigaoxueli = row[x];
					disabledForm.value.zuigaoxueli = true;
					continue;
				}
				if(x=='zaiduxuexiao'){
					form.value.zaiduxuexiao = row[x];
					disabledForm.value.zaiduxuexiao = true;
					continue;
				}
				if(x=='teshurenqun'){
					form.value.teshurenqun = row[x];
					disabledForm.value.teshurenqun = true;
					continue;
				}
				if(x=='nianling'){
