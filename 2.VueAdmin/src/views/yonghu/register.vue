	...
	<div>
		...
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">户号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.huhao" 
						 placeholder="请输入户号"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">是否户主：</div>
					<el-select 
						class="list_sel"
						v-model="registerForm.shifouhuzhu" 
						placeholder="请选择是否户主"
						>
				...
				<div class="list_item">
					<div class="list_label">常驻人口：</div>
					<el-input class="list_inp"
						 v-model="registerForm.changzhurenkou" 
						 placeholder="请输入常驻人口"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">最高学历：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zuigaoxueli" 
						 placeholder="请输入最高学历"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">在读学校：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zaiduxuexiao" 
						 placeholder="请输入在读学校"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">特殊人群：</div>
					<el-select 
						class="list_sel"
						v-model="registerForm.teshurenqun" 
						placeholder="请选择特殊人群"
						>
