		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="服务站详情" prop="fuwuzhanxiangqing">
							<editor :value="form.fuwuzhanxiangqing" placeholder="请输入服务站详情" :readonly="!isAdd||disabledForm.fuwuzhanxiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'fuwuzhanxiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.fuwuzhanxiangqing = res.data.data.fuwuzhanxiangqing?(res.data.data.fuwuzhanxiangqing.replace(reg,'../../../cl19290301/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fuwuzhanxiangqing'){
					form.value.fuwuzhanxiangqing = row[x];
					disabledForm.value.fuwuzhanxiangqing = true;
					continue;
				}
				if(x=='storeupnum'){
