	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="24">
						<el-form-item label="新闻标题" prop="xinwenbiaoti">
							<el-input class="list_inp" v-model="form.xinwenbiaoti" placeholder="新闻标题"
								 type="text" 								:readonly="!isAdd||disabledForm.xinwenbiaoti?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="新闻分类" prop="xinwenfenlei">
							<el-select
								class="list_sel"
					...
					<el-col :span="24">
						<el-form-item label="新闻简介" prop="xinwenjianjie">
							<el-input class="list_inp" v-model="form.xinwenjianjie" placeholder="新闻简介"
								 type="text" 								:readonly="!isAdd||disabledForm.xinwenjianjie?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="新闻内容" prop="xinwenneirong">
							<editor :value="form.xinwenneirong" placeholder="请输入新闻内容" :readonly="!isAdd||disabledForm.xinwenneirong?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'xinwenneirong')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xinwenneirong = res.data.data.xinwenneirong?(res.data.data.xinwenneirong.replace(reg,'../../../cl19290301/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='xinwenbiaoti'){
					form.value.xinwenbiaoti = row[x];
					disabledForm.value.xinwenbiaoti = true;
					continue;
				}
				if(x=='fengmian'){
				...
				if(x=='xinwenfenlei'){
					form.value.xinwenfenlei = row[x];
					disabledForm.value.xinwenfenlei = true;
					continue;
				}
				if(x=='xinwenjianjie'){
					form.value.xinwenjianjie = row[x];
					disabledForm.value.xinwenjianjie = true;
					continue;
				}
				if(x=='shipin'){
				...
				if(x=='xinwenneirong'){
					form.value.xinwenneirong = row[x];
					disabledForm.value.xinwenneirong = true;
					continue;
				}
				if(x=='faburiqi'){
		...
		context?.$http({
			...
			xinwenfenleiLists.value = res.data.data
		})
	}
	//初始化
	//声明父级调用
